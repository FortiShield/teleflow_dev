...
export class MessagesController {
  ...
  @ApiOperation({
    ...
    description: 'Deletes a message entity from the Teleflow platform',
  })
  ...
  @ApiOperation({
    ...
    description: 'Deletes messages entity from the Teleflow platform using TransactionId of message',
  })
