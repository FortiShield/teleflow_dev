...
import { colors, NavMenu, SegmentedControl, shadows, Translation } from '@teleflow/design-system';
import {
  Activity,
  Bolt,
  Box,
...
import { FeatureFlagsKeysEnum, UTM_CAMPAIGN_QUERY_PARAM } from '@teleflow/shared';
      ...
      <Navbar.Section sx={{ overflowY: 'auto', flex: 1 }}>
        ...
        <BottomNav dark={dark} data-test-id="side-nav-bottom-links">
          <a
            ...
            href="https://discord.teleflow.khulnasoft.com"
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href={`https://docs.teleflow.khulnasoft.com${UTM_CAMPAIGN_QUERY_PARAM}`}
