...
export const guidePreview: Record<string, IGuide> = {
  trigger: {
    ...
    docsUrl: `https://docs.teleflow.co/api-reference/events/trigger-event${UTM_CAMPAIGN_QUERY_PARAM}`,
    sequence: {
  ...
  digest: {
    ...
    docsUrl: `https://docs.teleflow.co/workflows/digest${UTM_CAMPAIGN_QUERY_PARAM}`,
    sequence: {
      1: { open: false, opacity: HINT_HIDDEN_OPACITY },
  ...
  email: {
    ...
    docsUrl: `https://docs.teleflow.co/channels-and-providers/integration-store${UTM_CAMPAIGN_QUERY_PARAM}`,
    sequence: {
      1: { open: false, opacity: HINT_HIDDEN_OPACITY },
      2: { open: false, opacity: HINT_HIDDEN_OPACITY },
