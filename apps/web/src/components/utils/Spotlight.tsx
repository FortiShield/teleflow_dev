...
import { Activity, Bolt, Box, Settings, Repeat, Team, Brand, Chat } from '@teleflow/design-system';
  ...
  useEffect(() => {
    addItem([
      ...
      },
      {
        ...
        onTrigger: () => {
          window?.open(`https://docs.teleflow.khulnasoft.com${UTM_CAMPAIGN_QUERY_PARAM}`, '_blank')?.focus();
        },
      },
      {
        id: 'navigate-support',
        title: 'Go to Support',
        onTrigger: () => {
          window?.open('https://discord.com/invite/teleflow', '_blank')?.focus();
        },
      },
      {
