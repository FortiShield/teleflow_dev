...
import { ChannelTypeEnum, UTM_CAMPAIGN_QUERY_PARAM } from '@teleflow/shared';
import { Bell, Chat, Mail, Mobile, Sms } from '@teleflow/design-system';
...
export const faqUrl = `https://docs.teleflow.khulnasoft.com/notification-center/introduction${UTM_CAMPAIGN_QUERY_PARAM}`;
export const notificationCenterDocsUrl = `https://docs.teleflow.khulnasoft.com/notification-center/introduction${UTM_CAMPAIGN_QUERY_PARAM}`;
export const discordInviteUrl = 'https://discord.gg/teleflow';
...
const embedScript = `<script>
  ...
  })(window, document, '${WIDGET_EMBED_PATH}', 'teleflow', 'script');

  teleflow.init('${APPLICATION_IDENTIFIER}', '#notification-bell', {
    subscriberId: "${onBoardingSubscriberId}",
  });
</script>`;
...
export const quickStartChannels: IQuickStartChannelConfiguration[] = [
  ...
  },
  {
    ...
    description: '🎉  Try our gift: 300 emails Use Teleflow provider for free or change the provider to yours',
    clickHandler: (options) => {
