...
export const faqUrl = `https://docs.teleflow.co/notification-center/introduction${UTM_CAMPAIGN_QUERY_PARAM}`;
export const notificationCenterDocsUrl = `https://docs.teleflow.co/notification-center/introduction${UTM_CAMPAIGN_QUERY_PARAM}`;
