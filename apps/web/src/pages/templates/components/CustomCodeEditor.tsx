...
const CustomCodeEditorBase = ({
  ...
  useEffect(() => {
    ...
    monacoRef.current.editor.setTheme(isDark ? 'teleflow-dark' : 'teleflow');
  }, [isDark]);
  ...
  return (
    <Editor
      ...
      onMount={(editor, monaco) => {
        ...
        const themeName = isDark ? 'teleflow-dark' : 'teleflow';
        monaco.editor.defineTheme('teleflow-dark', {
          base: 'vs-dark',
          inherit: true,
          rules: [],
          colors: {
        ...
        monaco.editor.defineTheme('teleflow', {
          base: 'vs',
          inherit: true,
          rules: [],
          colors: {
