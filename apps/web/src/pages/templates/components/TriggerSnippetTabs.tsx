...
import { INotificationTrigger, INotificationTriggerVariable, TemplateVariableTypeEnum } from '@teleflow/shared';
...
export const getNodeTriggerSnippet = (
  ...
  const triggerCodeSnippet = `import { Teleflow } from '@teleflow/node'; 

const teleflow = new Teleflow('<API_KEY>');

teleflow.trigger('${identifier}', ${JSON.stringify(
    {
      to,
      payload,
      overrides,
