...
import { AngularGradient, Copy, ReactGradient, VueGradient, JsGradient, CodeGradient } from '@teleflow/design-system';
  ...
  return (
    <>
      ...
      <Group spacing={16} mt={16} grow>
        <a
          href={`https://docs.teleflow.co/notification-center/client/web-component${UTM_CAMPAIGN_QUERY_PARAM}`}
          onClick={() => {
            setFramework('');
          }}
          rel="noreferrer"
        ...
        <a
          href={`https://docs.teleflow.co/notification-center/client/headless/get-started${UTM_CAMPAIGN_QUERY_PARAM}`}
          onClick={() => {
            setFramework('');
          }}
          rel="noreferrer"
