...
export function UpdateProviderSidebar({
  ...
  const isTeleflowInAppProvider = selectedProvider?.providerId === InAppProviderIdEnum.Teleflow;
  ...
  if (
    SmsProviderIdEnum.Teleflow === selectedProvider?.providerId ||
    EmailProviderIdEnum.Teleflow === selectedProvider?.providerId
  ) {
    return (
      <FormProvider {...methods}>
        <Sidebar
          ...
          data-test-id="update-provider-sidebar-teleflow"
          customFooter={
    ...
    <FormProvider {...methods}>
      <Sidebar
        ...
        customHeader={
          sidebarState === SidebarStateEnum.NORMAL ? (
            ...
            <>
              <When truthy={isTeleflowInAppProvider}>
      ...
      >
        <When truthy={sidebarState === SidebarStateEnum.NORMAL}>
          ...
          />
          {isTeleflowInAppProvider && <TeleflowInAppSetupWarning provider={selectedProvider} />}
          <UpdateIntegrationCommonFields provider={selectedProvider} />
          ...
          {isTeleflowInAppProvider && <TeleflowInAppFrameworks onFrameworkClick={onFrameworkClickCallback} />}
        </When>
        <When truthy={isTeleflowInAppProvider && sidebarState === SidebarStateEnum.EXPANDED}>
          <SetupTimeline
            framework={framework?.toString() ?? ''}
            onDone={() => {
              setSidebarState(SidebarStateEnum.NORMAL);
              successMessage('Successfully configured Teleflow In-App');
            }}
            onConfigureLater={() => {
              setSidebarState(SidebarStateEnum.NORMAL);
            }}
