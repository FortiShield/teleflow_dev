...
import { ChannelTypeEnum, IConfigCredentials } from '@teleflow/shared';

import { colors, shadows, Text, Tooltip } from '@teleflow/design-system';
...
function TooltipLabel({
  ...
  const label = isLimitReached
    ...
    : // eslint-disable-next-line max-len
      `The predefined free Teleflow provider allows sending ${limit} ${unit} per month. Configure a different ${channel} provider to send more.`;
