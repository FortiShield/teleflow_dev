    ...
    >
      ...
      <Stack spacing={24}>
        ...
        <Stack spacing={24}>
          <Stack spacing={16}>
            <Text>
              The free Teleflow provider allows sending {limit} {unit} per month
            </Text>
          ...
          <InlineDiv>
            ...
            <a
              href={`https://docs.teleflow.khulnasoft.com/channels-and-providers/integration-store${UTM_CAMPAIGN_QUERY_PARAM}`}
              target="_blank"
              rel="noreferrer"
