 ...
 */
import { DalService, IntegrationRepository, NotificationGroupRepository, NotificationTemplateEntity } from '@teleflow/dal';
import {
  UserSession,
  SubscribersService,
...
import { ChannelTypeEnum, getPopularTemplateIds, ProvidersIdEnum } from '@teleflow/shared';
...
module.exports = (on, config) => {
  ...
  on('task', {
    ...
    async clearDatabase() {
      ...
      await dal.connect('mongodb://127.0.0.1:27017/teleflow-test');
      await dal.destroy();
      return true;
    },
    async seedDatabase() {
