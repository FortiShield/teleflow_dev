...
const blueprintApiUrlByEnv = ENV === 'production' || ENV === 'prod' ? 'https://api.teleflow.co' : 'https://dev.api.teleflow.co';
...
export const MAIL_SERVER_DOMAIN =
  window._env_.REACT_APP_MAIL_SERVER_DOMAIN || process.env.REACT_APP_MAIL_SERVER_DOMAIN || 'dev.inbound-mail.teleflow.co';
