...
describe('test use of teleflows node package - Subscribers class', () => {
  ...
  test('should update subscriber correctly', async () => {
    ...
    await teleflow.subscribers.update('test-update-subscriber', {
      phone: '8989898',
      locale: 'en',
  ...
  test('should delete subscriber correctly', async () => {
    ...
    await teleflow.subscribers.delete('test-delete-subscriber');
  ...
  test('should delete subscriber provider credentials correctly', async () => {
    ...
    await teleflow.subscribers.deleteCredentials('test-update-subscriber', 'slack');
  ...
  test('should unset subscriber channel credentials correctly', async () => {
    ...
    await teleflow.subscribers.unsetCredentials('test-update-subscriber', 'slack');
  ...
  test('should identify subscriber correctly', async () => {
    ...
    await teleflow.subscribers.identify('test-new-subscriber', {
      firstName: 'Test',
      lastName: 'Identify',
      email: 'email',
    });
  ...
  test('should update subscriber online status', async () => {
    ...
    await teleflow.subscribers.updateOnlineStatus('test-update-subscriber', true);
  ...
  test('should get subscriber preference', async () => {
    ...
    await teleflow.subscribers.getPreference('test-subscriber-preference');
  ...
  test('should update subscriber preference', async () => {
    ...
    await teleflow.subscribers.updatePreference(
  ...
  test('should get notification feed for subscriber correctly', async () => {
    ...
    await teleflow.subscribers.getNotificationsFeed(
  ...
  test('should get notification feed for subscriber with optional feedIdentifier', async () => {
    ...
    await teleflow.subscribers.getNotificationsFeed('test-news-feed-subscriber', {
      feedIdentifier: '123',
    });
  ...
  test('should get unseen notification count for subscribers feed', async () => {
    ...
    await teleflow.subscribers.getUnseenCount('test-unseen-count', false);
  ...
  test('should mark subscriber feed message as seen', async () => {
    ...
    await teleflow.subscribers.markMessageSeen('test-message-seen', 'message-123');
  ...
  test('should mark subscriber feed message as read', async () => {
    ...
    await teleflow.subscribers.markMessageRead('test-message-read', 'message-123');
