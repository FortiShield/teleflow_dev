...
describe('Teleflow Node.js package - Organizations class', () => {
  ...
  it('should list organizations', async () => {
    ...
    const result = await teleflow.organizations.list();
  ...
  it('should create new organization', async () => {
    ...
    const result = await teleflow.organizations.create(payload);
  ...
  it('should rename current organization', async () => {
    ...
    const result = await teleflow.organizations.rename(payload);
  ...
  it('should fetch current organization', async () => {
    ...
    const result = await teleflow.organizations.getCurrent();
  ...
  it('should remove member from current organization', async () => {
    ...
    const result = await teleflow.organizations.removeMember(mockedMember.id);
  ...
  it('should update member role in current organization', async () => {
    ...
    const result = await teleflow.organizations.updateMemberRole(
      mockedMember.id,
      payload
    );
  ...
  it('should fetch all members of current organization', async () => {
    ...
    const result = await teleflow.organizations.getMembers();
  ...
  it('should update branding details of current organization', async () => {
    ...
    const result = await teleflow.organizations.updateBranding(payload);
