...
describe('Teleflow Node.js package - Topics class', () => {
  ...
  test('should rename topic', async () => {
    ...
    const result = await teleflow.topics.rename(key, name);
  ...
  test('should get topic subscriber by the external subscriber ID', async () => {
    ...
    const result = await teleflow.topics.getSubscriber(
      topicKey,
      externalSubscriberId
    );
  ...
  test('should list topics', async () => {
    ...
    const result = await teleflow.topics.list({ page: 0 });
  ...
  test('should list topics with selected pageSize', async () => {
    ...
    const result = await teleflow.topics.list({ page: 0, pageSize });
  ...
  test('should add subscribers', async () => {
    ...
    const result = await teleflow.topics.addSubscribers(topicId, { subscribers });
  ...
  test('should remove subscribers', async () => {
    ...
    const result = await teleflow.topics.removeSubscribers(topicId, {
      subscribers,
    });
