import { darkButtonStyle, lightButtonStyle } from '@teleflow/shared';

import { colors } from './colors';
import { shadows } from './shadows';
import { INotificationBellColors, ITeleflowTheme } from '../../store/teleflow-theme.context';
import { ICommonTheme } from '../../store/teleflow-theme-provider.context';

const defaultLightTheme: ITeleflowTheme = {
  layout: {
...
const defaultDarkTheme: ITeleflowTheme = {
  layout: {
