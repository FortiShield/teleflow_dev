...
import { IEnvironment, SignUpOriginEnum } from '@teleflow/shared';
...
async function handleOnboardingFlow(config: ConfigService) {
  ...
  try {
    ...
    we've developed a quick start that will guide you through setting up and testing Teleflow notifications with ease.
