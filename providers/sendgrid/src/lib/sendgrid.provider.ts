...
export class SendgridEmailProvider implements IEmailProvider {
  ...
  private createMailData(options: IEmailOptions) {
    ...
    const mailData: Partial<MailDataRequired> = {
      ...
      customArgs: {
        id: options.id,
        teleflowTransactionId: options.notificationDetails?.transactionId,
        teleflowMessageId: options.id,
        teleflowWorkflowIdentifier: options.notificationDetails?.workflowIdentifier,
        teleflowSubscriberId: options.notificationDetails?.subscriberId,
        ...options.customData,
      },
